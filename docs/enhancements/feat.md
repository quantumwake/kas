...
- [~] `/self-skill` v0 SHIPPED (propose-only): reviews session history → writes skill proposals to `.agent/skills/PROPOSALS-*.md`. Execution of self-authored skills still pending the dispatcher. Skills/plugins runtime — [skills.md](skills.md)
