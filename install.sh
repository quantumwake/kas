...
#   remote:       curl -fsSL https://raw.githubusercontent.com/quantumwake/kascli/main/install.sh | sh
#
...
REPO="git+https://github.com/quantumwake/kascli"   # https: works for public + gh-authed private
PYVER="3.11"
